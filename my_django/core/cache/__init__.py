...
the abstract BaseCache class in my_django.core.cache.backends.base.
...
from my_django.core.cache.backends.base import (
...
if not settings.CACHES:
    ...
    if engine in backend_classes:
        engine = 'my_django.core.cache.backends.%s' % backend_classes[engine]
    else:
