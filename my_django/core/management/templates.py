...
from my_django.utils import archive
from my_django.utils.encoding import smart_str
from my_django.utils._os import rmtree_errorhandler
from my_django.core.management.base import BaseCommand, CommandError
from my_django.core.management.commands.makemessages import handle_extensions
...
class TemplateCommand(BaseCommand):
    ...
    :param style: A color style object (see my_django.core.management.color).
    ...
    def handle_template(self, template, subdir):
        ...
        Use my_django.__path__[0] as the default because we don't
        know into which directory Django has been installed.
        """
        if template is None:
            return path.join(my_django.__path__[0], 'conf', subdir)
        else:
