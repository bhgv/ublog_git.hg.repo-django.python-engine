...
def get_validation_errors(outfile, app=None):
    ...
    from my_django.db import models, connection
    from my_django.db.models.loading import get_app_errors
    from my_django.db.models.fields.related import RelatedObject
    from my_django.db.models.deletion import SET_NULL, SET_DEFAULT
