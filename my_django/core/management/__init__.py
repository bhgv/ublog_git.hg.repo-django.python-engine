...
from my_django.core.management.base import BaseCommand, CommandError, handle_default_options
from my_django.core.management.color import color_style
...
def get_commands():
    ...
    This works by looking for a management.commands package in my_django.core, and
    ...
    if _commands is None:
        _commands = dict([(name, 'my_django.core') for name in find_commands(__path__[0])])
...
class ManagementUtility(object):
    ...
    def autocomplete(self):
        ...
        # special case: the 'help' subcommand has no options
            ...
            # 'key=value' pairs
            if cwords[0] == 'runfcgi':
                from my_django.core.servers.fastcgi import FASTCGI_OPTIONS
