...
from my_django.db import (connections, router, transaction, DEFAULT_DB_ALIAS,
      IntegrityError, DatabaseError)
from my_django.db.models import get_apps
from my_django.utils.itercompat import product
