...
from my_django.core.wsgi import get_wsgi_application
from my_django.utils.importlib import import_module
from my_django.utils._os import safe_join
from my_django.views import static

from my_django.contrib.staticfiles import handlers
...
class AdminMediaHandler(handlers.StaticFilesHandler):
    ...
    def get_base_dir(self):
        return os.path.join(my_django.__path__[0], 'contrib', 'admin', 'static', 'admin')
