...
from my_django.middleware.csrf import get_token
from my_django.utils.functional import lazy
...
from my_django.contrib.auth.context_processors import PermLookupDict as RealPermLookupDict
from my_django.contrib.auth.context_processors import PermWrapper as RealPermWrapper
