...
from my_django.core.files.uploadedfile import TemporaryUploadedFile, InMemoryUploadedFile
...
def load_handler(path, *args, **kwargs):
    ...
    E.g.::
        >>> load_handler('my_django.core.files.uploadhandler.TemporaryFileUploadHandler', request)
