...
from my_django.core.urlresolvers import set_script_prefix
from my_django.utils import datastructures
from my_django.utils.encoding import force_unicode, iri_to_uri
from my_django.utils.log import getLogger

logger = getLogger('my_django.request')
...
class ModPythonRequest(http.HttpRequest):
    def __init__(self, req):
        ...
        root = req.get_options().get('my_django.root', '')
...
class ModPythonHandler(BaseHandler):
    ...
    def __call__(self, req):
        ...
        set_script_prefix(req.get_options().get('my_django.root', ''))
