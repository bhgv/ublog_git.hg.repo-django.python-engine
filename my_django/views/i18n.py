...
from my_django.utils.translation import check_for_language, activate, to_locale, get_language
from my_django.utils.text import javascript_quote
from my_django.utils.encoding import smart_unicode
from my_django.utils.formats import get_format_modules, get_format
...
def javascript_catalog(request, domain='djangojs', packages=None):
    ...
    packages = [p for p in packages if p == 'my_django.conf' or p in settings.INSTALLED_APPS]
