from my_django.template import loader, RequestContext
from my_django.http import HttpResponse, HttpResponseRedirect, HttpResponsePermanentRedirect, HttpResponseGone
...
def redirect_to(request, url, permanent=True, query_string=False, **kwargs):
    ...
    ``/foo/<id>/`` to ``/bar/<id>/``, you could use the following URLconf::
        ...
        urlpatterns = patterns('',
            ('^foo/(?P<id>\d+)/$', 'my_django.views.generic.simple.redirect_to', {'url' : '/bar/%(id)s/'}),
        )
