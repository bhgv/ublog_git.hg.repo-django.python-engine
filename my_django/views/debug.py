...
from my_django.http import (HttpResponse, HttpResponseServerError,
    HttpResponseNotFound, HttpRequest, build_request_repr)
from my_django.template import Template, Context, TemplateDoesNotExist
from my_django.template.defaultfilters import force_escape, pprint
from my_django.utils.html import escape
from my_django.utils.importlib import import_module
from my_django.utils.encoding import smart_unicode, smart_str
...
class ExceptionReporter(object):
    ...
    def get_traceback_data(self):
        ...
        if self.exc_type and issubclass(self.exc_type, TemplateDoesNotExist):
            from my_django.template.loader import template_source_loaders
    ...
    def get_traceback_frames(self):
        ...
        while tb is not None:
            ...
            if pre_context_lineno is not None:
                frames.append({
                    'tb': tb,
                    'type': module_name.startswith('my_django.') and 'my_django' or 'user',
                    'filename': filename,
                    'function': function,
                    'lineno': lineno + 1,
