...
from my_django.template import (Context, RequestContext,
                             loader, TemplateDoesNotExist)
from my_django.views.decorators.csrf import requires_csrf_token
...
def shortcut(request, content_type_id, object_id):
    ...
    # installed.
    from my_django.contrib.contenttypes.views import shortcut as real_shortcut
