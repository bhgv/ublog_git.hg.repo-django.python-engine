...
from my_django.db.backends.mysql.client import DatabaseClient
from my_django.db.backends.mysql.creation import DatabaseCreation
from my_django.db.backends.mysql.introspection import DatabaseIntrospection
from my_django.db.backends.mysql.validation import DatabaseValidation
from my_django.utils.safestring import SafeString, SafeUnicode
...
class DatabaseOperations(BaseDatabaseOperations):
    compiler_module = "my_django.db.backends.mysql.compiler"
