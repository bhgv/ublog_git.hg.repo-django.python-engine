...
from my_django.db import DEFAULT_DB_ALIAS
from my_django.db.backends import util
from my_django.db.transaction import TransactionManagementError
from my_django.utils.importlib import import_module
from my_django.utils.timezone import is_aware
...
class BaseDatabaseFeatures(object):
    ...
    # True if my_django.db.backend.utils.typecast_timestamp is used on values
...
class BaseDatabaseOperations(object):
    ...
    row.
    """
    compiler_module = "my_django.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, sequences):
        ...
        color_style() or no_style() in my_django.core.management.color.
        """
        raise NotImplementedError()
...
class BaseDatabaseIntrospection(object):
    ...
    def django_table_names(self, only_existing=False):
        ...
        """
        from my_django.db import models, router
        tables = set()
