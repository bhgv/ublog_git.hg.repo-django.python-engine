...
from my_django.db.backends.oracle.client import DatabaseClient
from my_django.db.backends.oracle.creation import DatabaseCreation
from my_django.db.backends.oracle.introspection import DatabaseIntrospection
...
class DatabaseOperations(BaseDatabaseOperations):
    compiler_module = "my_django.db.backends.oracle.compiler"
