...
from my_django.utils import tree
from my_django.db.models.fields import Field
from my_django.db.models.sql.datastructures import EmptyResultSet, FullResultSet
from my_django.db.models.sql.aggregates import Aggregate
...
class Constraint(object):
    ...
    def process(self, lookup_type, value, connection):
        ...
        from my_django.db.models.base import ObjectDoesNotExist
        try:
            if self.field:
