...
from my_django.db.models.query_utils import select_related_descend
...
from my_django.db.models.sql.query import get_order_dir, Query
...
class SQLDateCompiler(SQLCompiler):
    def results_iter(self):
        ...
        resolve_columns = hasattr(self, 'resolve_columns')
        if resolve_columns:
            from my_django.db.models.fields import DateTimeField
            fields = [DateTimeField()]
        else:
            from my_django.db.backends.util import typecast_timestamp
