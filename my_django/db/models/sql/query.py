...
from my_django.utils.tree import Node
from my_django.db import connections, DEFAULT_DB_ALIAS
from my_django.db.models import signals
from my_django.db.models.expressions import ExpressionNode
from my_django.db.models.fields import FieldDoesNotExist
from my_django.db.models.query_utils import InvalidQuery
from my_django.db.models.sql import aggregates as base_aggregates_module
from my_django.db.models.sql.constants import *
from my_django.db.models.sql.datastructures import EmptyResultSet, Empty, MultiJoin
from my_django.db.models.sql.expressions import SQLEvaluator
from my_django.db.models.sql.where import (WhereNode, Constraint, EverythingNode,
    ExtraWhere, AND, OR)
from my_django.core.exceptions import FieldError
...
class Query(object):
    ...
    def get_aggregation(self, using):
        ...
        if self.group_by is not None:
            from my_django.db.models.sql.subqueries import AggregateQuery
