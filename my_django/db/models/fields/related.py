...
from my_django.db import connection, router
from my_django.db.backends import util
from my_django.db.models import signals, get_model
from my_django.db.models.fields import (AutoField, Field, IntegerField,
    PositiveIntegerField, PositiveSmallIntegerField, FieldDoesNotExist)
from my_django.db.models.related import RelatedObject
from my_django.db.models.query import QuerySet
from my_django.db.models.query_utils import QueryWrapper
from my_django.db.models.deletion import CASCADE
from my_django.utils.encoding import smart_unicode
from my_django.utils.translation import ugettext_lazy as _, string_concat
from my_django.utils.functional import curry, cached_property
...
def create_many_related_manager(superclass, rel):
    ...
    class ManyRelatedManager(superclass):
        ...
        def _add_items(self, source_field_name, target_field_name, *objs):
            ...
            from my_django.db.models import Model
            if objs:
                new_ids = set()
                for obj in objs:
