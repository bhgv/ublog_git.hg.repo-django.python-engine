...
import warnings
from my_django.conf import settings, UserSettingsHolder
from my_django.core import mail
from my_django.test.signals import template_rendered, setting_changed
from my_django.template import Template, loader, TemplateDoesNotExist
from my_django.template.loaders import cached
from my_django.utils.translation import deactivate
from my_django.utils.functional import wraps
...
def setup_test_environment():
    ...
    settings.EMAIL_BACKEND = 'my_django.core.mail.backends.locmem.EmailBackend'
...
class override_settings(object):
    ...
    def __call__(self, test_func):
        from my_django.test import TransactionTestCase
