...
from my_django.contrib.staticfiles.handlers import StaticFilesHandler
from my_django.core import mail
from my_django.core.exceptions import ValidationError, ImproperlyConfigured
from my_django.core.handlers.wsgi import WSGIHandler
from my_django.core.management import call_command
from my_django.core.signals import request_started
from my_django.core.servers.basehttp import (WSGIRequestHandler, WSGIServer,
    WSGIServerException)
from my_django.core.urlresolvers import clear_url_caches
from my_django.core.validators import EMPTY_VALUES
from my_django.db import (transaction, connection, connections, DEFAULT_DB_ALIAS,
    reset_queries)
from my_django.forms.fields import CharField
from my_django.http import QueryDict
from my_django.test import _doctest as doctest
from my_django.test.client import Client
from my_django.test.html import HTMLParseError, parse_html
from my_django.test.signals import template_rendered
from my_django.test.utils import (get_warnings_state, restore_warnings_state,
    override_settings)
from my_django.test.utils import ContextList
from my_django.utils import simplejson, unittest as ut2
from my_django.utils.encoding import smart_str, force_unicode
from my_django.utils.unittest.util import safe_repr
from my_django.views.static import serve
...
class LiveServerThread(threading.Thread):
    ...
    def run(self):
        ...
        if self.connections_override:
            from my_django.db import connections
...
class LiveServerTestCase(TransactionTestCase):
    ...
    def setUpClass(cls):
        ...
        for conn in connections.all():
            ...
            # the server thread.
            if (conn.settings_dict['ENGINE'] == 'my_django.db.backends.sqlite3'
