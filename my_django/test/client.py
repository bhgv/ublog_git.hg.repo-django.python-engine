...
from my_django.core.handlers.base import BaseHandler
from my_django.core.handlers.wsgi import WSGIRequest
from my_django.core.signals import got_request_exception
from my_django.http import SimpleCookie, HttpRequest, QueryDict
from my_django.template import TemplateDoesNotExist
from my_django.test import signals
from my_django.utils.functional import curry
from my_django.utils.encoding import smart_str
from my_django.utils.http import urlencode
from my_django.utils.importlib import import_module
from my_django.utils.itercompat import is_iterable
from my_django.db import close_connection
...
class ClientHandler(BaseHandler):
    ...
    def __call__(self, environ):
        from my_django.conf import settings
        from my_django.core import signals
...
class Client(RequestFactory):
    ...
    def _session(self):
        ...
        """
        if 'my_django.contrib.sessions' in settings.INSTALLED_APPS:
    ...
    def login(self, **credentials):
        ...
        if user and user.is_active \
                and 'my_django.contrib.sessions' in settings.INSTALLED_APPS:
            engine = import_module(settings.SESSION_ENGINE)
