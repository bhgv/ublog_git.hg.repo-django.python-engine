...
from my_django.template.base import Variable, Library, VariableDoesNotExist
from my_django.conf import settings
from my_django.utils import formats
from my_django.utils.dateformat import format, time_format
from my_django.utils.encoding import force_unicode, iri_to_uri
from my_django.utils.html import (conditional_escape, escapejs, fix_ampersands,
    escape, urlize as urlize_impl, linebreaks, strip_tags)
from my_django.utils.http import urlquote
from my_django.utils.text import Truncator, wrap, phone2numeric
from my_django.utils.safestring import mark_safe, SafeData, mark_for_escaping
from my_django.utils.timesince import timesince, timeuntil
from my_django.utils.translation import ugettext, ungettext
from my_django.utils.text import normalize_newlines
