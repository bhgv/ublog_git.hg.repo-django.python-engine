...
from my_django.template.base import (Node, NodeList, Template, Library,
    TemplateSyntaxError, VariableDoesNotExist, InvalidTemplateLibrary,
    BLOCK_TAG_START, BLOCK_TAG_END, VARIABLE_TAG_START, VARIABLE_TAG_END,
    SINGLE_BRACE_START, SINGLE_BRACE_END, COMMENT_TAG_START, COMMENT_TAG_END,
    VARIABLE_ATTRIBUTE_SEPARATOR, get_library, token_kwargs, kwarg_re)
from my_django.template.smartif import IfParser, Literal
from my_django.template.defaultfilters import date
from my_django.utils.encoding import smart_str, smart_unicode
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from my_django.utils.html import strip_spaces_between_tags
