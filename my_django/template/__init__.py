...
from my_django.template.base import (ALLOWED_VARIABLE_CHARS, BLOCK_TAG_END,
...
# Exceptions
from my_django.template.base import (ContextPopException, InvalidTemplateLibrary,
    TemplateDoesNotExist, TemplateEncodingError, TemplateSyntaxError,
    VariableDoesNotExist)

# Template parts
from my_django.template.base import (Context, FilterExpression, Lexer, Node,
...
# Compiling templates
from my_django.template.base import (compile_string, resolve_variable,
    unescape_string_literal, generic_tag_compiler)

# Library management
from my_django.template.base import (Library, add_to_builtins, builtins,
