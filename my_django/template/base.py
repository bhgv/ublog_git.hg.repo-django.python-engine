...
from my_django.template.context import (Context, RequestContext,
    ContextPopException)
from my_django.utils.importlib import import_module
from my_django.utils.itercompat import is_iterable
from my_django.utils.text import (smart_split, unescape_string_literal,
    get_text_list)
from my_django.utils.encoding import smart_unicode, force_unicode, smart_str
from my_django.utils.translation import ugettext_lazy, pgettext_lazy
from my_django.utils.safestring import (SafeData, EscapeData, mark_safe,
    mark_for_escaping)
from my_django.utils.formats import localize
from my_django.utils.html import escape
from my_django.utils.module_loading import module_has_submodule
from my_django.utils.timezone import localtime
...
def compile_string(template_string, origin):
    ...
    if settings.TEMPLATE_DEBUG:
        from my_django.template.debug import DebugLexer, DebugParser
            ...
            class InclusionNode(TagHelperNode):
                ...
                def render(self, context):
                    ...
                    if not getattr(self, 'nodelist', False):
                        from my_django.template.loader import get_template, select_template
...
add_to_builtins('my_django.template.defaulttags')
add_to_builtins('my_django.template.defaultfilters')
