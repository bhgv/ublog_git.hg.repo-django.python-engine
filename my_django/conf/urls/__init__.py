from my_django.core.urlresolvers import (RegexURLPattern,
...
handler403 = 'my_django.views.defaults.permission_denied'
handler404 = 'my_django.views.defaults.page_not_found'
handler500 = 'my_django.views.defaults.server_error'
