...
from my_django.utils import dateformat, numberformat, datetime_safe
...
from my_django.utils.translation import get_language, to_locale, check_for_language
...
def iter_format_modules(lang):
    ...
    if check_for_language(lang):
        format_locations = ['my_django.conf.locale.%s']
