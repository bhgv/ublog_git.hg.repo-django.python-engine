...
class Trans(object):
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from my_django.utils.translation import trans_real as trans
            ...
            from my_django.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from my_django.conf.locale import LANG_INFO
    try:
