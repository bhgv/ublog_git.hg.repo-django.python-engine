...
from my_django.contrib.databrowse.plugins.calendars import CalendarPlugin
from my_django.contrib.databrowse.plugins.objects import ObjectDetailPlugin
from my_django.contrib.databrowse.plugins.fieldchoices import FieldChoicePlugin
