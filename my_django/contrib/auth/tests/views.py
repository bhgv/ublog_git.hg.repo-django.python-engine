...
from my_django.contrib.sites.models import Site, RequestSite
...
from my_django.contrib.auth import SESSION_KEY, REDIRECT_FIELD_NAME
from my_django.contrib.auth.forms import (AuthenticationForm, PasswordChangeForm,
...
class AuthViewsTestCase(TestCase):
    ...
    urls = 'my_django.contrib.auth.tests.urls'
...
class AuthViewNamedURLTests(AuthViewsTestCase):
    urls = 'my_django.contrib.auth.urls'
...
class LoginTest(AuthViewsTestCase):
    ...
    def test_current_site_in_context_after_login(self):
        response = self.client.get(reverse('my_django.contrib.auth.views.login'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_security_check(self, password='password'):
        login_url = reverse('my_django.contrib.auth.views.login')
...
class LogoutTest(AuthViewsTestCase):
    ...
    def test_security_check(self, password='password'):
        logout_url = reverse('my_django.contrib.auth.views.logout')
