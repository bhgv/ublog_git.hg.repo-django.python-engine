...
from my_django.contrib.auth.backends import RemoteUserBackend
...
class RemoteUserTest(TestCase):
    ...
    middleware = 'my_django.contrib.auth.middleware.RemoteUserMiddleware'
    backend = 'my_django.contrib.auth.backends.RemoteUserBackend'
...
class RemoteUserNoCreateTest(RemoteUserTest):
    ...
    backend =\
        'my_django.contrib.auth.tests.remote_user.RemoteUserNoCreateBackend'
...
class RemoteUserCustomTest(RemoteUserTest):
    ...
    backend =\
        'my_django.contrib.auth.tests.remote_user.CustomRemoteUserBackend'
