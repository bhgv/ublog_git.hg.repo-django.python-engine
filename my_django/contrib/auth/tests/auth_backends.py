...
from my_django.contrib.auth.models import User, Group, Permission, AnonymousUser
...
class BackendTest(TestCase):
    ...
    backend = 'my_django.contrib.auth.backends.ModelBackend'
...
class RowlevelBackendTest(TestCase):
    ...
    """
    backend = 'my_django.contrib.auth.tests.auth_backends.SimpleRowlevelBackend'
...
class AnonymousUserBackendTest(TestCase):
    ...
    backend = 'my_django.contrib.auth.tests.auth_backends.AnonymousUserBackend'
...
class InActiveUserBackendTest(TestCase):
    ...
    backend = 'my_django.contrib.auth.tests.auth_backends.InActiveUserBackend'
...
class NoInActiveUserBackendTest(TestCase):
    ...
    """
    backend = 'my_django.contrib.auth.tests.auth_backends.NoInActiveUserBackend'
