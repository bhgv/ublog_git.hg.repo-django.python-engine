...
from my_django.forms import ValidationError
from my_django.forms.fields import Field, RegexField, Select, CharField
...
class USStateField(Field):
    ...
    def clean(self, value):
        from my_django.contrib.localflavor.us.us_states import STATES_NORMALIZED
...
class USStateSelect(Select):
    ...
    def __init__(self, attrs=None):
        from my_django.contrib.localflavor.us.us_states import STATE_CHOICES
...
class USPSSelect(Select):
    ...
    """
    def __init__(self, attrs=None):
        from my_django.contrib.localflavor.us.us_states import USPS_CHOICES
