...
from my_django.contrib.comments.models import Comment
from my_django.contrib.comments.forms import CommentForm
from my_django.utils.importlib import import_module

DEFAULT_COMMENTS_APP = 'my_django.contrib.comments'
...
def get_form_target():
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_form_target"):
        ...
        return urlresolvers.reverse("my_django.contrib.comments.views.comments.post_comment")
...
def get_flag_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_flag_url"):
        ...
        return urlresolvers.reverse("my_django.contrib.comments.views.moderation.flag",
                                    args=(comment.id,))
...
def get_delete_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_delete_url"):
        ...
        return urlresolvers.reverse("my_django.contrib.comments.views.moderation.delete",
                                    args=(comment.id,))
...
def get_approve_url(comment):
    ...
    if get_comment_app_name() != DEFAULT_COMMENTS_APP and hasattr(get_comment_app(), "get_approve_url"):
        ...
        return urlresolvers.reverse("my_django.contrib.comments.views.moderation.approve",
                                    args=(comment.id,))
