...
from my_django.contrib.auth.models import AnonymousUser, User
from my_django.template import Template, Context, TemplateSyntaxError
from my_django.test import TestCase

class FlatpageTemplateTagTests(TestCase):
    fixtures = ['sample_flatpages']
    urls = 'my_django.contrib.flatpages.tests.urls'

    def setUp(self):
        self.old_MIDDLEWARE_CLASSES = settings.MIDDLEWARE_CLASSES
        flatpage_middleware_class = 'my_django.contrib.flatpages.middleware.FlatpageFallbackMiddleware'
