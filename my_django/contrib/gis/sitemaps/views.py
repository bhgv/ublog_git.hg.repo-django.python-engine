...
from my_django.template import loader
...
from my_django.db.models import get_model
from my_django.utils.encoding import smart_str
from my_django.utils.translation import ugettext as _

from my_django.contrib.gis.shortcuts import render_to_kml, render_to_kmz
...
def index(request, sitemaps):
    ...
    for section, site in sitemaps.items():
        if callable(site):
            ...
            pages = site.paginator.num_pages
        sitemap_url = urlresolvers.reverse('my_django.contrib.gis.sitemaps.views.sitemap', kwargs={'section': section})
