...
from my_django.contrib.gis.geos.mutable_list import ListMixin

# GEOS-related dependencies.
from my_django.contrib.gis.geos.base import GEOSBase, gdal
...
from my_django.contrib.gis.geos.libgeos import GEOM_PTR, GEOS_PREPARE
from my_django.contrib.gis.geos.mutable_list import ListMixin
...
from my_django.contrib.gis.geos.prototypes.io import wkt_r, wkt_w, wkb_r, wkb_w, ewkb_w, ewkb_w3d
...
class GEOSGeometry(GEOSBase, ListMixin):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of my_django.utils.tree;
...
if GEOS_PREPARE:
    from my_django.contrib.gis.geos.prepared import PreparedGeometry
