...
from my_django.contrib.gis.geos.prototypes.coordseq import (create_cs, get_cs,
    cs_clone, cs_getordinate, cs_setordinate, cs_getx, cs_gety, cs_getz,
    cs_setx, cs_sety, cs_setz, cs_getsize, cs_getdims)

# Geometry routines.
from my_django.contrib.gis.geos.prototypes.geom import (from_hex, from_wkb, from_wkt,
...
from my_django.contrib.gis.geos.prototypes.misc import *

# Predicates
from my_django.contrib.gis.geos.prototypes.predicates import (geos_hasz, geos_isempty,
...
# Topology routines
from my_django.contrib.gis.geos.prototypes.topology import *
