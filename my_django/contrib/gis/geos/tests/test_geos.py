...
from my_django.contrib.gis.geos.base import gdal, numpy, GEOSBase
from my_django.contrib.gis.geos.libgeos import GEOS_PREPARE
from my_django.contrib.gis.geometry.test_data import TestDataMixin
...
class GEOSTest(unittest.TestCase, TestDataMixin):
    ...
    def test28_geos_version(self):
        ...
        from my_django.contrib.gis.geos.libgeos import version_regex
