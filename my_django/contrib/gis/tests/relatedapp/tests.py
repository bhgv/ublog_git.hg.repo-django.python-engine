...
from my_django.contrib.gis.geos import GEOSGeometry, Point, MultiPoint
from my_django.contrib.gis.db.models import Collect, Count, Extent, F, Union
from my_django.contrib.gis.geometry.backend import Geometry
from my_django.contrib.gis.tests.utils import mysql, oracle, no_mysql, no_oracle, no_spatialite
...
class RelatedGeoModelTest(TestCase):
    ...
    def test11_geoquery_pickle(self):
        ...
        import pickle
        from my_django.contrib.gis.db.models.sql import GeoQuery
        qs = City.objects.all()
