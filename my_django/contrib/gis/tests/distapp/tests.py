...
from my_django.contrib.gis.geos import GEOSGeometry, LineString
from my_django.contrib.gis.measure import D # alias for Distance
from my_django.contrib.gis.tests.utils import oracle, postgis, spatialite, no_oracle, no_spatialite
