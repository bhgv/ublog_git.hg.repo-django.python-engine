...
from my_django.contrib.gis.tests.utils import no_mysql, no_spatialite
from my_django.contrib.gis.shortcuts import render_to_kmz
from my_django.db.models import Count
