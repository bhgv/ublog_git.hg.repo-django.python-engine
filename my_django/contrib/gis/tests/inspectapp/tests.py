...
from my_django.contrib.gis.gdal import Driver
from my_django.contrib.gis.geometry.test_data import TEST_DATA
from my_django.contrib.gis.utils.ogrinspect import ogrinspect
...
class OGRInspectTest(TestCase):
    def test_poly(self):
        ...
        expected = [
            ...
            'from my_django.contrib.gis.db import models',
            '',
...
def get_ogr_db_string():
    ...
    drivers = {
        'my_django.contrib.gis.db.backends.postgis': ('PostgreSQL', 'PG'),
    }
