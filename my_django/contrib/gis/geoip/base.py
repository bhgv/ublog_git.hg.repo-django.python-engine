...
from my_django.core.validators import ipv4_re
from my_django.contrib.gis.geoip.libgeoip import GEOIP_SETTINGS
from my_django.contrib.gis.geoip.prototypes import (
...
class GeoIP(object):
    ...
    def geos(self, query):
        ...
        if ll:
            from my_django.contrib.gis.geos import Point
