...
from my_django.contrib.gis.db.models import GeometryField
from my_django.contrib.gis.gdal import (CoordTransform, DataSource,
    OGRException, OGRGeometry, OGRGeomType, SpatialReference)
from my_django.contrib.gis.gdal.field import (
    OFTDate, OFTDateTime, OFTInteger, OFTReal, OFTString, OFTTime)
from my_django.db import models, transaction
from my_django.contrib.localflavor.us.models import USStateField
