...
from my_django.contrib.gis.gdal.field import OFTDate, OFTDateTime, OFTInteger, OFTReal, OFTString, OFTTime
...
def ogrinspect(*args, **kwargs):
    ...
    >>> from my_django.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from my_django.contrib.gis.db import models` code from the
