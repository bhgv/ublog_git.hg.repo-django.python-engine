...
from my_django.db.backends.oracle.base import DatabaseOperations
from my_django.contrib.gis.db.backends.base import BaseSpatialOperations
from my_django.contrib.gis.db.backends.oracle.adapter import OracleSpatialAdapter
from my_django.contrib.gis.db.backends.util import SpatialFunction
...
class OracleOperations(DatabaseOperations, BaseSpatialOperations):
    compiler_module = "my_django.contrib.gis.db.backends.oracle.compiler"
    ...
    def geometry_columns(self):
        from my_django.contrib.gis.db.backends.oracle.models import GeometryColumns
        return GeometryColumns

    def spatial_ref_sys(self):
        from my_django.contrib.gis.db.backends.oracle.models import SpatialRefSys
