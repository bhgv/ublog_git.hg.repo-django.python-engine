...
from my_django.db.backends.sqlite3.base import (
    ...
    SQLiteCursorWrapper)
from my_django.contrib.gis.db.backends.spatialite.client import SpatiaLiteClient
from my_django.contrib.gis.db.backends.spatialite.creation import SpatiaLiteCreation
from my_django.contrib.gis.db.backends.spatialite.introspection import SpatiaLiteIntrospection
from my_django.contrib.gis.db.backends.spatialite.operations import SpatiaLiteOperations
