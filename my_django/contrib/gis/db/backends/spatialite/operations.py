...
from my_django.contrib.gis.db.backends.base import BaseSpatialOperations
from my_django.contrib.gis.db.backends.util import SpatialOperation, SpatialFunction
from my_django.contrib.gis.db.backends.spatialite.adapter import SpatiaLiteAdapter
from my_django.contrib.gis.geometry.backend import Geometry
from my_django.contrib.gis.measure import Distance
from my_django.core.exceptions import ImproperlyConfigured
from my_django.db.backends.sqlite3.base import DatabaseOperations
from my_django.db.utils import DatabaseError
...
class SpatiaLiteOperations(DatabaseOperations, BaseSpatialOperations):
    compiler_module = 'my_django.contrib.gis.db.models.sql.compiler'
    name = 'spatialite'
    spatialite = True
    ...
    def geometry_columns(self):
        from my_django.contrib.gis.db.backends.spatialite.models import GeometryColumns
        return GeometryColumns

    def spatial_ref_sys(self):
        from my_django.contrib.gis.db.backends.spatialite.models import SpatialRefSys
