...
from my_django.contrib.gis.db.backends.postgis.adapter import PostGISAdapter
...
from my_django.db.backends.postgresql_psycopg2.base import DatabaseOperations
...
class PostGISOperations(DatabaseOperations, BaseSpatialOperations):
    ...
    def geometry_columns(self):
        from my_django.contrib.gis.db.backends.postgis.models import GeometryColumns
        return GeometryColumns

    def spatial_ref_sys(self):
        from my_django.contrib.gis.db.backends.postgis.models import SpatialRefSys
