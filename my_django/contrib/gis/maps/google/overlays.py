...
from my_django.contrib.gis.geos import fromstr, Point, LineString, LinearRing, Polygon
...
class GEvent(object):
    ...
    Example:
      ...
      from my_django.contrib.gis.maps.google import GoogleMap, GEvent, GPolyline
...
class GMarker(GOverlayBase):
    ...
    Example:
      ...
      from my_django.shortcuts import render_to_response
      from my_django.contrib.gis.maps.google.overlays import GMarker, GEvent
