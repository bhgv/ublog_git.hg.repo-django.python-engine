"""
   ...
   * GOOGLE_MAPS_URL (optional): Must have a substitution ('%s') for the API
      version.
"""
from my_django.contrib.gis.maps.google.gmap import GoogleMap, GoogleMapSet
from my_django.contrib.gis.maps.google.overlays import GEvent, GIcon, GMarker, GPolygon, GPolyline
from my_django.contrib.gis.maps.google.zoom import GoogleZoom
