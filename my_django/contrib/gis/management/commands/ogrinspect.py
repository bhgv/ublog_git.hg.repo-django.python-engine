...
from my_django.contrib.gis import gdal
from my_django.core.management.base import LabelCommand, CommandError
...
class Command(LabelCommand):
    ...
    option_list = LabelCommand.option_list + (
        ...
        make_option('--no-imports', action='store_false', dest='imports', default=True,
                    help='Do not include `from my_django.contrib.gis.db import models` '
                    'statement.'),
    ...
    def handle(self, *args, **options):
        ...
        # and options.
        from my_django.contrib.gis.utils.ogrinspect import _ogrinspect, mapping
