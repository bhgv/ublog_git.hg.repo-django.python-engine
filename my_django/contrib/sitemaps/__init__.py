...
from my_django.core import urlresolvers, paginator
...
def ping_google(sitemap_url=None, ping_url=PING_URL):
    ...
    if sitemap_url is None:
        try:
            ...
            sitemap_url = urlresolvers.reverse('my_django.contrib.sitemaps.views.index')
        except urlresolvers.NoReverseMatch:
            try:
                # Next, try for the "global" sitemap URL.
                sitemap_url = urlresolvers.reverse('my_django.contrib.sitemaps.views.sitemap')
            except urlresolvers.NoReverseMatch:
                pass
