...
from my_django.contrib.sitemaps import Sitemap, GenericSitemap, FlatPageSitemap, views
from my_django.contrib.auth.models import User
from my_django.views.decorators.cache import cache_page
...
urlpatterns = patterns('my_django.contrib.sitemaps.views',
