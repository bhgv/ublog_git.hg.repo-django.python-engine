...
from my_django.contrib.sitemaps import Sitemap, GenericSitemap
...
from my_django.utils.translation import activate, deactivate
...
""" % date.today())
    ...
    @skipUnless("my_django.contrib.sites" in settings.INSTALLED_APPS,
                "my_django.contrib.sites app not installed.")
