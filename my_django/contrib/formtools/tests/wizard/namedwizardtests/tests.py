...
from my_django.contrib.formtools.wizard.views import (NamedUrlSessionWizardView,
                                                   NamedUrlCookieWizardView)
from my_django.contrib.formtools.tests.wizard.forms import get_request, Step1, Step2


class NamedWizardTests(object):
    urls = 'my_django.contrib.formtools.tests.wizard.namedwizardtests.urls'
