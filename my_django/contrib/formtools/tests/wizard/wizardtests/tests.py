...
from my_django.test.client import RequestFactory
from my_django.conf import settings
from my_django.contrib.auth.models import User
from my_django.contrib.formtools.wizard.views import CookieWizardView
from my_django.contrib.formtools.tests.wizard.forms import UserForm, UserFormSet


class WizardTests(object):
    urls = 'my_django.contrib.formtools.tests.wizard.wizardtests.urls'
