...
from my_django.contrib.formtools import preview, utils
from my_django.contrib.formtools.wizard import FormWizard
...
from my_django.contrib.formtools.tests.wizard import *
from my_django.contrib.formtools.tests.forms import *

warnings.filterwarnings('ignore', category=PendingDeprecationWarning,
                        module='my_django.contrib.formtools.wizard')
...
class PreviewTests(FormToolsTestCase):
    urls = 'my_django.contrib.formtools.tests.urls'

    def setUp(self):
        super(PreviewTests, self).setUp()
        self.save_warnings_state()
        warnings.filterwarnings('ignore', category=DeprecationWarning,
                                module='my_django.contrib.formtools.utils')
