...
"""
from my_django.forms import HiddenInput
from my_django.http import Http404
from my_django.shortcuts import render_to_response
from my_django.template.context import RequestContext
from my_django.utils.crypto import constant_time_compare
...
from my_django.contrib.formtools.utils import form_hmac
...
class FormWizard(object):
    ...
    def __init__(self, form_list, initial=None):
        ...
        warnings.warn(
            ...
            'views in my_django.contrib.formtools.wizard.views instead.',
    ...
    def __call__(self, request, *args, **kwargs):
        """
        Main method that does all the hard work, conforming to the my_django view
        interface.
        """
