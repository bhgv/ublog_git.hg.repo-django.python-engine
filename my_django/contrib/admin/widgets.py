...
from my_django.forms.widgets import RadioFieldRenderer
from my_django.forms.util import flatatt
from my_django.utils.html import escape
from my_django.utils.text import Truncator
    ...
    if lookups and hasattr(lookups, 'items'):
        ...
        for k, v in lookups.items():
            if isinstance(v, (tuple, list)):
                ...
                # See my_django.db.fields.BooleanField.get_prep_lookup
                v = ('0', '1')[v]
            else:
                v = unicode(v)
            items.append((k, v))
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    def url_parameters(self):
        from my_django.contrib.admin.views.main import TO_FIELD_VAR
