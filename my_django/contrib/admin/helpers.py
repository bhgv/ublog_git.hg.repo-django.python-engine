...
from my_django.contrib.admin.util import (flatten_fieldsets, lookup_field,
...
from my_django.db.models.fields.related import ManyToManyRel
from my_django.forms.util import flatatt
from my_django.template.defaultfilters import capfirst
from my_django.utils.encoding import force_unicode, smart_unicode
from my_django.utils.html import escape, conditional_escape
...
class InlineAdminForm(AdminForm):
    ...
    def deletion_field(self):
        from my_django.forms.formsets import DELETION_FIELD_NAME
        return AdminField(self.form, DELETION_FIELD_NAME, False)

    def ordering_field(self):
        from my_django.forms.formsets import ORDERING_FIELD_NAME
