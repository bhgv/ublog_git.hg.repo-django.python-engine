...
from my_dulwich.greenthreads import (
    GreenThreadsMissingObjectFinder,
    GreenThreadsObjectStoreIterator,
    )

from my_dulwich.lru_cache import LRUSizeCache
...
from my_dulwich.protocol import TCP_GIT_PORT
...
def cmd_daemon(args):
    ...
    from my_dulwich.contrib.swift import load_conf
