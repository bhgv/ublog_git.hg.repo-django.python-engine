...
from my_dulwich.tests.test_object_store import (
    ObjectStoreTests,
    )
...
if not missing_libs:
    from my_dulwich.contrib import swift
...
class TestSwiftRepo(TestCase):
    ...
    def test_init(self):
        ...
        with patch('my_dulwich.contrib.swift.SwiftConnector',
...
class TestSwiftConnector(TestCase):
    ...
    def test_create_root(self):
        with patch('my_dulwich.contrib.swift.SwiftConnector.test_root_exists',
                   lambda *args: None):
            with patch('geventhttpclient.HTTPClient.request',
                       lambda *args: Response()):
    ...
    def test_del_root(self):
        with patch('my_dulwich.contrib.swift.SwiftConnector.del_object',
                   lambda *args: None):
            with patch('my_dulwich.contrib.swift.SwiftConnector.'
