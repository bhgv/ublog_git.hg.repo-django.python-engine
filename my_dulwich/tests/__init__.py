...
def self_test_suite():
    ...
    module_names = ['my_dulwich.tests.test_' + name for name in names]
    loader = unittest.TestLoader()
    return loader.loadTestsFromNames(module_names)


def tutorial_test_suite():
    import my_dulwich.client  # noqa: F401
    import my_dulwich.config  # noqa: F401
    import my_dulwich.index  # noqa: F401
    import my_dulwich.reflog  # noqa: F401
    import my_dulwich.repo  # noqa: F401
    import my_dulwich.server  # noqa: F401
    import my_dulwich.patch  # noqa: F401
    tutorial = [
        'introduction',
        'file-format',
        'repo',
    ...
    return doctest.DocFileSuite(
            module_relative=True, package='my_dulwich.tests',
...
def nocompat_test_suite():
    ...
    from my_dulwich.contrib import test_suite as contrib_test_suite
...
def compat_test_suite():
    result = unittest.TestSuite()
    from my_dulwich.tests.compat import test_suite as compat_test_suite
