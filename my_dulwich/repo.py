...
from my_dulwich.hooks import (
    PreCommitShellHook,
    PostCommitShellHook,
    CommitMsgShellHook,
    )

from my_dulwich.refs import (  # noqa: F401
    check_ref_format,
    RefsContainer,
    DictRefsContainer,
    InfoRefsContainer,
...
class BaseRepo(object):
    ...
    def _init_files(self, bare):
        ...
        from my_dulwich.config import ConfigFile
    ...
    def get_config_stack(self):
        ...
        """
        from my_dulwich.config import StackedConfig
    ...
    def get_walker(self, include=None, *args, **kwargs):
        ...
        """
        from my_dulwich.walk import Walker
        if include is None:
            include = [self.head()]
...
class Repo(BaseRepo):
    ...
    def open_index(self):
        ...
        :return: The matching `Index`
        """
        from my_dulwich.index import Index
