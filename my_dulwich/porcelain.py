...
from my_dulwich.archive import (
    tar_stream,
    )
from my_dulwich.client import (
    get_transport_and_path,
    )
from my_dulwich.config import (
    StackedConfig,
    )
from my_dulwich.diff_tree import (
    CHANGE_ADD,
    CHANGE_DELETE,
    CHANGE_MODIFY,
    CHANGE_RENAME,
...
from my_dulwich.ignore import IgnoreFilterManager
from my_dulwich.index import (
    blob_from_path_and_stat,
    get_unstaged_changes,
    )
from my_dulwich.object_store import (
    tree_lookup_path,
    )
from my_dulwich.objects import (
    Commit,
    Tag,
    format_timezone,
    parse_timezone,
...
from my_dulwich.objectspec import (
    parse_commit,
    parse_object,
    parse_ref,
    parse_reftuples,
...
from my_dulwich.pack import (
    write_pack_index,
    write_pack_objects,
    )
from my_dulwich.patch import write_tree_diff
from my_dulwich.protocol import (
    Protocol,
    ZERO_SHA,
    )
from my_dulwich.refs import (
    ANNOTATED_TAG_SUFFIX,
    strip_peeled_refs,
)
from my_dulwich.repo import (BaseRepo, Repo)
from my_dulwich.server import (
    FileSystemBackend,
    TCPGitServer,
    ReceivePackHandler,
    UploadPackHandler,
...
def check_mailmap(repo, contact):
    ...
    """
    with open_repo_closing(repo) as r:
        from my_dulwich.mailmap import Mailmap
        import errno
        try:
...
def stash_list(repo):
    ...
    with open_repo_closing(repo) as r:
        from my_dulwich.stash import Stash
