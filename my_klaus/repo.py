...
from my_dulwich.objects import S_ISGITLINK
from my_dulwich.object_store import tree_lookup_path
from my_dulwich.objects import Blob
from my_dulwich.errors import NotTreeError
import my_dulwich, my_dulwich.patch
from my_dulwich.repo import Repo
...
class FancyRepo(Repo):
    ...
    def get_last_updated_at(self):
        ...
        for ref in refs:
            ...
            if hasattr(ref, "commit_time"):
                last_update_time = datetime.fromtimestamp(ref.commit_time)
    ...
    def get_description(self):
        ...
        if description:
            if not description.startswith(b"Unnamed repository;"):
                return description
    ...
    def get_commit(self, rev):
        ...
        for prefix in ['refs/heads/', 'refs/tags/', '']:
            ...
            try:
                ...
                if isinstance(obj, my_dulwich.objects.Tag):
    ...
    def raw_commit_diff(self, commit):
        if commit.parents:
            ...
            parent_tree = None
        bytesio = io.BytesIO()
        my_dulwich.patch.write_tree_diff(bytesio, self.object_store, parent_tree, commit.tree)
