...
from my_mercurial import util, encoding
...
funcs = '''os.path.join os.path.split os.path.splitext
 ...
 my_mercurial.util.endswithsep my_mercurial.util.splitpath my_mercurial.util.checkcase
 my_mercurial.util.fspath my_mercurial.util.pconvert my_mercurial.util.normpath'''
...
def extsetup(ui):
    ...
    if _encoding.lower() in problematic_encodings.split():
        for f in funcs.split():
            wrapname(f, wrapper)
        wrapname("my_mercurial.osutil.listdir", wrapperforlistdir)
